...
function smallShirts() {
  return data.filter((dataObj) => dataObj.shirt_size === "XS" || dataObj.shirt_size === "S").sort((dataObjA, dataObjB) => (dataObjA.first_name > dataObjB.first_name ? 1 : -1));
}
...
function smallShirts() {
  return data
    .filter((dataObj) => dataObj.shirt_size === "XS" || dataObj.shirt_size === "S")
    .map((dataObj) => ({
      id: dataObj.id,
      first_name: dataObj.first_name,
      shirt_size: dataObj.shirt_size,
    }))
    .sort((dataObjA, dataObjB) => (dataObjA.first_name > dataObjB.first_name ? 1 : -1));
}
